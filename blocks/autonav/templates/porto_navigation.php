                            ...
                            echo '<div class="row">';
                                ...
                                echo '<div class="col-md-5">';
                                    echo '<ul style="list-style:none;">';
                                        ...
                                        if (Config::get('concrete.user.profiles_enabled')) {
                                            echo '<li><a href="'.URL::to('/members', 'directory').'" class="portoMenuLinkTextColorll"><i class="fa fa-users"></i> '.t('Users').'</a></li>';
                                        }
                                        echo '<li><a href="'.URL::to('/account').'" class="portoMenuLinkTextColorll"><i class="fa fa-cog"></i> '.t('Settings').'</a></li>';
                                        echo '<li><a href="'.URL::to('/account/messages/', 'inbox').'"  class="portoMenuLinkTextColorll"><i class="fa fa-comment"></i> '.t('Messages').'</a></li>';
                                        if (is_object($pk=PermissionKey::getByHandle('porto_dashboard')) && $pk->can()) {
                                            echo '<li><a href="'.URL::to('/dashboard/porto_design').'" class="portoMenuLinkTextColorll" target="_blank"><i class="fa fa-dashboard"></i> '.t('Administration').'</a></li>';
                                        }
                                ...
                                echo '<div class="row">';
                                    echo '<div class="col-md-12">';
                                        echo '<div class="signin-form">';
                                            echo '<div style="float:left;margin-right:3px"><span style="font-size:20px">'.t('Login').'</span></div>';
